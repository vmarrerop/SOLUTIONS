...
import { Camera, Keyboard, Zap, CheckCircle2 } from 'lucide-react'
...
export function EscanearPage() {
  ...
  const simularLectura = () => {
    setDetectado(true)
    setTimeout(() => navigate('/equipos/eq-01'), 1200)
  }
  ...
  return (
    <div className="mx-auto max-w-xl space-y-5">
      <PageHeader
        ...
        subtitle="Apunte la cámara al QR del equipo para abrir su ficha y formulario de revisión."
      />
            ...
            <div className="relative size-56">
              ...
              {detectado && (
                <span className="absolute inset-0 flex flex-col items-center justify-center gap-2 rounded-xl bg-emerald-500/15 text-emerald-400">
                  ...
                  <span className="text-sm font-bold">SRV-001 detectado</span>
                </span>
              )}
            </div>
          </div>
